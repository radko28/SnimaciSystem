<%-- 
    ...
    Created on : Dec 7, 2008, 11:42:44 PM
    Author     : radko28
--%>
...
out.print("<td rowspan=9><img src = "+fileUtil.getResourceValue("image.url")+ pic +" alt = photo /></td></tr>");
    ...
    <tr><th align = "left">Mobil</th><td align = "left"><%= mobil %></td></tr>
    <tr><th align = "left">Street</th><td align = "left"><%= streetView %></td></tr>
    <tr><th align = "left">City</th><td align = "left"><%= cityView %></td></tr>
    <tr><th align = "left">Zip</th><td align = "left"><%= zip %></td></tr>
    <tr><th align = "left">Web</th><td align = "left">
        <%
